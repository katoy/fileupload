...
describe 'kusamakura', ->
  ...
  it 'ncx.navpoint', ->
    ...
    expect(@info.ncx.navPoint[0]).toEqual({ id: 'cover_page', playOrder: '1', text: '草枕', content: 'Text/cover.xhtml', level: 1 })
    expect(@info.ncx.navPoint[1]).toEqual({ id: 'title_page', playOrder: '2', text: 'タイトル', content: 'Text/titlepage.xhtml', level: 1 })
    expect(@info.ncx.navPoint[2]).toEqual({ id: 'nav',        playOrder: '3', text: '目次', content: 'Text/navigation.xhtml', level: 1 })
    expect(@info.ncx.navPoint[3]).toEqual({ id: 'content001', playOrder: '4', text: '一', content: 'Text/content001.xhtml', level: 1 })
    expect(@info.ncx.navPoint[4]).toEqual({ id: 'content002', playOrder: '5', text: '二', content: 'Text/content002.xhtml', level: 1 })
    expect(@info.ncx.navPoint[5]).toEqual({ id: 'content003', playOrder: '6', text: '三', content: 'Text/content003.xhtml', level: 1 })
    expect(@info.ncx.navPoint[6]).toEqual({ id: 'content004', playOrder: '7', text: '四', content: 'Text/content004.xhtml', level: 1 })
    expect(@info.ncx.navPoint[7]).toEqual({ id: 'content005', playOrder: '8', text: '五', content: 'Text/content005.xhtml', level: 1 })
    expect(@info.ncx.navPoint[8]).toEqual({ id: 'content006', playOrder: '9', text: '六', content: 'Text/content006.xhtml', level: 1 })
    expect(@info.ncx.navPoint[9]).toEqual({ id: 'content007', playOrder: '10', text: '七', content: 'Text/content007.xhtml', level: 1 })
    expect(@info.ncx.navPoint[10]).toEqual({ id: 'content008',playOrder: '11', text: '八', content: 'Text/content008.xhtml', level: 1 })
    expect(@info.ncx.navPoint[11]).toEqual({ id: 'content009',playOrder: '12', text: '九', content: 'Text/content009.xhtml', level: 1 })
    expect(@info.ncx.navPoint[12]).toEqual({ id: 'content010',playOrder: '13', text: '十', content: 'Text/content010.xhtml', level: 1 })
    expect(@info.ncx.navPoint[13]).toEqual({ id: 'content011',playOrder: '14', text: '十一', content: 'Text/content011.xhtml', level: 1 })
    expect(@info.ncx.navPoint[14]).toEqual({ id: 'content012',playOrder: '15', text: '十二', content: 'Text/content012.xhtml', level: 1 })
    expect(@info.ncx.navPoint[15]).toEqual({ id: 'content013',playOrder: '16', text: '十三', content: 'Text/content013.xhtml', level: 1 })
