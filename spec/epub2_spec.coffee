...
describe 'alice', ->
  ...
  it 'ncx.navpoint', ->
    ...
    expect(@info.ncx.navPoint[0]).toEqual({ id: 'np-1', playOrder: '1', text: 'THE "STORYLAND" SERIES', content: 'www.gutenberg.org@files@19033@19033-h@19033-h-0.htm#pgepubid00000' },)
    expect(@info.ncx.navPoint[1]).toEqual({ id: 'np-2', playOrder: '3', text: 'ALICE\'S ADVENTURES IN WONDERLAND', content: 'www.gutenberg.org@files@19033@19033-h@19033-h-0.htm#pgepubid00002' })
    expect(@info.ncx.navPoint[2]).toEqual({ id: 'np-3', playOrder: '5', text: 'SAM\'L GABRIEL SONS & COMPANY NEW YORK', content: 'www.gutenberg.org@files@19033@19033-h@19033-h-0.htm#pgepubid00004' })
    expect(@info.ncx.navPoint[3]).toEqual({ id: 'np-4', playOrder: '7', text: 'Copyright, 1916, by SAM\'L GABRIEL SONS & COMPANY NEW YORK', content: 'www.gutenberg.org@files@19033@19033-h@19033-h-0.htm#pgepubid00006' })
    expect(@info.ncx.navPoint[4]).toEqual({ id: 'np-5', playOrder: '8', text: 'I—DOWN THE RABBIT-HOLE',content: 'www.gutenberg.org@files@19033@19033-h@19033-h-0.htm#pgepubid00007' })
    expect(@info.ncx.navPoint[5]).toEqual({ id: 'np-6', playOrder: '15', text: 'II—THE POOL OF TEARS', content: 'www.gutenberg.org@files@19033@19033-h@19033-h-0.htm#pgepubid00014' })
    expect(@info.ncx.navPoint[6]).toEqual({ id: 'np-7', playOrder: '21', text: 'III—A CAUCUS-RACE AND A LONG TALE',content: 'www.gutenberg.org@files@19033@19033-h@19033-h-0.htm#pgepubid00020' })
    expect(@info.ncx.navPoint[7]).toEqual({ id: 'np-8', playOrder: '28', text: 'IV—THE RABBIT SENDS IN A LITTLE BILL',content: 'www.gutenberg.org@files@19033@19033-h@19033-h-0.htm#pgepubid00027' })
    expect(@info.ncx.navPoint[8]).toEqual({ id: 'np-9', playOrder: '35', text: 'V—ADVICE FROM A CATERPILLAR',content: 'www.gutenberg.org@files@19033@19033-h@19033-h-0.htm#pgepubid00034' })
    expect(@info.ncx.navPoint[9]).toEqual({ id: 'np-10', playOrder: '41', text: 'VI—PIG AND PEPPER',content: 'www.gutenberg.org@files@19033@19033-h@19033-h-0.htm#pgepubid00040' })
    expect(@info.ncx.navPoint[10]).toEqual({ id: 'np-11', playOrder: '46', text: 'VII—A MAD TEA-PARTY',content: 'www.gutenberg.org@files@19033@19033-h@19033-h-0.htm#pgepubid00045' })
    expect(@info.ncx.navPoint[11]).toEqual({ id: 'np-12', playOrder: '49', text: 'VIII—THE QUEEN\'S CROQUET GROUND',content: 'www.gutenberg.org@files@19033@19033-h@19033-h-0.htm#pgepubid00048' })
    expect(@info.ncx.navPoint[12]).toEqual({ id: 'np-13', playOrder: '55', text: 'IX—WHO STOLE THE TARTS?',content: 'www.gutenberg.org@files@19033@19033-h@19033-h-0.htm#pgepubid00054'})
    expect(@info.ncx.navPoint[13]).toEqual({ id: 'np-14', playOrder: '59', text: 'X—ALICE\'S EVIDENCE',content: 'www.gutenberg.org@files@19033@19033-h@19033-h-0.htm#pgepubid00058' })
